...
class ProjectRules extends Rules
{
   ...
   public function messages()
   {
      $this->createMessages('name', [
         'between' => "Nazwa projektu powinna zawierać od " . $this->value('name.min') . " do " . $this->value('name.max') . " znaków",
         'specialCharacters' => "Nazwa projektu nie może zawierać znaków specjalnych",
      ]);
